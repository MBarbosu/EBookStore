...
values('2801010121111', 'Pop Ana', 'iniana123','admin');
...
insert into EBOOKS.USERS(SSN, NAME, PASSWORD, ROLE)
values('29999999', 'test','test','admin');
------------------------
...
create table Ebooks.Orders (ID varchar(50) primary key, ISNBN_Ebbok varchar(50), Status varchar(50));

insert into Ebooks.Orders values ('1', '123456', 'Delivered');

insert into Ebooks.Orders values ('2', '666', 'New');

insert into Ebooks.Orders values('3', 'asafacem', 'In progress');

insert into Ebooks.Orders values ('4', 'blablabal', 'Rejected');
